    ...
    return(
        ...
        <aside className=" hidden sm:flex">
            <div className="flex flex-col items-center w-25 h-screen py-8 space-y-8 bg-white dark:bg-gray-900 dark:border-gray-700 border-r  border-[#FF8660] ">
                ...
                <a href="#education" className="p-1.5 text-[#FF8660] focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-[#A95D74]">
